    ...
    "node_modules/mithril/render/hyperscript.js"(exports, module) {
      ...
      function execSelector(state, vnode) {
        ...
        if (state.attrs !== emptyAttrs) {
          ...
          if (className != null || state.attrs.className != null) attrs.className = className != null ? state.attrs.className != null ? String(state.attrs.className) + " " + String(className) : className : state.attrs.className;
        } else {
